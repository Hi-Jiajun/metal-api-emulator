; Owned synthetic source counterpart to mix_3d.metal.
target datalayout = "e-p:64:64:64"
target triple = "air64-apple-macosx14.0.0"

define void @mix_3d(ptr addrspace(1) %values, ptr addrspace(1) %bias, ptr addrspace(1) %output, <3 x i32> %gid) {
entry:
  ...
  %combined = xor i32 %old, %amount
  %scaled = mul i32 %combined, 3
  %value = add i32 %scaled, 1
  store i32 %value, ptr addrspace(1) %slot, align 4
  %masked = add i32 %value, 270544960
