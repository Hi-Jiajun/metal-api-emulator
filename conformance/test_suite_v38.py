...
`suite-v38.json` carries one translated render case against one declaring pass:
...
V37_PATH = CONFORMANCE / "suite-v38.json"
...
class DeclaredSupersetTests(unittest.TestCase):
    ...
    def test_the_suite_carries_the_declaring_pass_and_the_superset_case(self):
        self.assertEqual(self.suite["suite"], "compute-buffer-v38")
