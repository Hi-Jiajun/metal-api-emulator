...
- Open design work: device-loss reclamation beyond the bounded abandonment
  ...
  lifecycle wiring beyond the owner-side contract, and wiring the
  priority/fairness queue policy into the live queue selection and the
  trace/wire boundary (the core contract and algorithm now exist). Resource
